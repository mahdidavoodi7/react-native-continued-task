...
namespace margelo::nitro::continuedtask {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/continuedtask/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/continuedtask/Func_void_cxx;";
