...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::continuedtask::ListenerSubscription> final {
    static inline margelo::nitro::continuedtask::ListenerSubscription fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::continuedtask::ListenerSubscription(
        JSIConverter<std::function<void()>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "remove")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::continuedtask::ListenerSubscription& arg) {
